...
abstract class Styles {
  ...
  static TextStyle onboardingTextHintColor12 = TextStyle(
  ...
  static TextStyle onboardingTextHintColor14 = TextStyle(
    fontWeight: FontWeight.normal,
    color: ColorsValue.textFieldHintColor,
  ...
  static TextStyle onboardingTextHintColor16 = TextStyle(
    fontWeight: FontWeight.normal,
    color: ColorsValue.textFieldHintColor,
  ...
  static TextStyle onboardingBold14 = TextStyle(
  ...
  static TextStyle onboardingBold16 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.blackColor,
    fontSize: Dimens.sixteen,
    height: 2,
  ...
  static TextStyle boldBlack32 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.blackColor,
  ...
  static TextStyle boldButtonBg12 = TextStyle(
    fontWeight: FontWeight.bold,
  ...
  static TextStyle boldGolden12 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.goldenColor,
    fontSize: Dimens.twelve,
  );

  static TextStyle boldGolden14 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.goldenColor,
    fontSize: Dimens.fourteen,
  );

  static TextStyle mediumGolden14 = TextStyle(
    fontWeight: FontWeight.w500,
    color: ColorsValue.goldenColor,
    fontSize: Dimens.fourteen,
  );
  ...
  static TextStyle textFieldLabelStyle14 = TextStyle(
    fontWeight: FontWeight.w500,
    color: ColorsValue.textFieldHintColor,
    fontSize: Dimens.fourteen,
  );
  ...
  static TextStyle mediumBlue16 = TextStyle(
    fontWeight: FontWeight.w500,
  ...
  static TextStyle accountReady24 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.accountReadyColor,
    fontSize: Dimens.twentyFour,
  );

  static TextStyle accountReady32 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.accountReadyColor,
    fontSize: Dimens.thirty + Dimens.two,
  );

  static TextStyle boldGreen12 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.greenColor,
    fontSize: Dimens.twelve,
  );

  static TextStyle congrats20 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.congratsTextColor,
    fontSize: Dimens.twenty,
  );

  static TextStyle congrats24 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.congratsTextColor,
    fontSize: Dimens.twentyFour,
  );
  static TextStyle congrats32 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.congratsTextColor,
    fontSize: Dimens.thirty + Dimens.two,
  );
  static TextStyle accountReadyLineSpace32 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.accountReadyColor,
    fontSize: Dimens.thirty + Dimens.two,
    height: 1.5,
  ...
  static TextStyle boldBlackLineSpacing16 = TextStyle(
    fontWeight: FontWeight.bold,
    color: ColorsValue.blackColor,
    fontSize: Dimens.sixteen,
    height: 1.5,
  ...
  static TextStyle mediumRed12 = TextStyle(
    fontWeight: FontWeight.w500,
    color: ColorsValue.congratsTextColor,
    fontSize: Dimens.twelve,
  );
  ...
  static TextStyle mediumRed15 = TextStyle(
    fontWeight: FontWeight.w500,
    color: ColorsValue.congratsTextColor,
    fontSize: Dimens.twelve,
  );
  ...
  static TextStyle swapMeetTextAddImage12 = TextStyle(
    fontWeight: FontWeight.w500,
    color: ColorsValue.swapMeetAddIconColor,
    fontSize: Dimens.twelve,
  );
  static TextStyle swapMeetTextAddImage14 = TextStyle(
    fontWeight: FontWeight.w500,
    color: ColorsValue.swapMeetAddIconColor,
    fontSize: Dimens.fourteen,
  );

  static TextStyle progressBarGreen10 = TextStyle(
    fontWeight: FontWeight.w500,
    color: ColorsValue.darkGreenColor,
    fontSize: Dimens.fourteen,
  );
  static TextStyle progressBarRed10 = TextStyle(
    fontWeight: FontWeight.w500,
    color: ColorsValue.darkRedColor,
    fontSize: Dimens.fourteen,
  );

  static TextStyle dropDown12 = TextStyle(
    fontWeight: FontWeight.w500,
